        ...
        <div className="h-full py-16 antialiased bg-primary-very-light font-sans">
            ...
            >
                ...
                >
                    ...
                    <h2 className="pb-4 flex justify-center font-bold border-b border-gray-200">
                        <span className="text-3xl mt-6 mr-1">$</span
                        ><span className="text-6xl"> 199.99</span>
                    </h2>
                    <ul className="text-sm font-bold">
                        <li className="pt-4 pb-4 border-b border-gray-200">500 GB Storage</li>
                        <li className="pt-3 pb-4 border-b border-gray-200">2 Users Allowed</li>
                        <li className="pt-4 pb-4 border-b border-gray-200">Send up to 3 GB</li>
                    </ul>
                    <button
                ...
                >
                    ...
                    <ul className="text-sm font-bold">
                        ...
                        <li className="pt-4 pb-4 border-b border-gray-200">Send up to 20 GB</li>
                    </ul>
                    <button
